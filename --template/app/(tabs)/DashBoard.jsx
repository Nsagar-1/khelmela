  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.row_bundler}>
        <Image
          source={{
            uri: "https://lh3.googleusercontent.com/a/ACg8ocJZDpshB1tudnsQuWi6-s7FWoS8lR_9rmk41gQ4Qmj7BIMycrZS=s96-c",
          }}
        />
      ...
      <View style={styles.iconsContainer}>
        ...
        <View style={styles.iconWrapper}>
          ...
          >
            <Image
              source={require("../../assets/images/pubg.jpg")}
              style={styles.icon}
            />
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.iconWrapper}>
          ...
          >
            <Image
              source={require("../../assets/images/COD1.png")}
              style={styles.icon}
            />
          </TouchableOpacity>
        </View>
      ...
      <View style={styles.selectModeContainer}>
        ...
        <View style={styles.modesContainer}>{renderPannel(Pannel)}</View>
      </View>
